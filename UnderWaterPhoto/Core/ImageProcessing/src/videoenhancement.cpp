...
//#include "../src/contrastenhancement.cpp"

void getHistogramm(cv::Mat *channel, cv::Mat *hist) {								// Computes the histogram of a single channel
	int histSize = 256;
